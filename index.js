...
if (!settings || !settings.pterodactyl.domain || !settings.pterodactyl.key || settings.pterodactyl.domain.split(".").includes("example")) {
    console.log(chalk.red("[ERROR]") + chalk.white(" Pterodactyl is not configured! Please configure it in the settings file and restart the application."));
    process.exit(1);
}
...
const listener = app.listen(settings.website.port, function () {
    ...
    console.log(`${chalk.gray("[+]")} ${chalk.white("[")}${chalk.cyan("Website")}${chalk.white("]")}${chalk.white(" https://holaclient.dev ")}`);
    console.log(chalk.white("================================================="));
    console.log(" ");
