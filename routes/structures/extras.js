...
module.exports.load = async function(app, db) {
  ...
  app.get("/info", async (req, res) => {
    ...
    <main class="grid min-h-screen place-content-center place-items-center overflow-hidden">
      ...
      <a href="https://holaclient.dev" target="blank" class="bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] bg-clip-text text-6xl font-bold leading-[1.2] tracking-tighter text-transparent">
